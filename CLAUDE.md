...
- [ ] Claude Design Handover — full visual rebuild from the canonical Horizon prototype (`docs/handoff/`): gold/ink Meridian token rewrite, new primitives/components, five reskinned screens, Import UI shell, and the four supporting migrations (category color, account sortOrder, account showInTrajectory, mortgage origination)

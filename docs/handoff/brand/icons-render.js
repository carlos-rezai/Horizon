/* Renders the Horizon icon set into #icons. Plain JS — works opened directly.
   Paths mirror src/icons.jsx (the source of truth). */
const ICONS = {
...
Object.keys(ICONS).forEach((name) => {
  ...
  svg.setAttribute("fill", solid ? "#E6B559" : "none");
  svg.setAttribute("stroke", solid ? "none" : "#ECEEF2");

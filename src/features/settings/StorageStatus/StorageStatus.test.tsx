...
describe("StorageStatus — SQLite payload", () => {
...
describe("StorageStatus — Mongo payload", () => {
...
describe("StorageStatus — Download backup button (SQLite)", () => {
...
describe("StorageStatus — Download backup button (Mongo)", () => {
...
describe("StorageStatus — Restore from backup button (SQLite)", () => {
  ...
  it("clicking the button opens a hidden file input", async () => {
    mockRestoreFetch();
    renderComponent();
...
describe("StorageStatus — Restore from backup button (Mongo)", () => {
